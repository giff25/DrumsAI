...
const osThreadAttr_t Scheduler_attributes = {
  ...
  .stack_mem = &SchedulerBuffer[0],
  .stack_size = sizeof(SchedulerBuffer),
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for AquireSensorDat */
...
const osThreadAttr_t AquireSensorDat_attributes = {
  ...
  .stack_mem = &AquireSensorDatBuffer[0],
...
const osThreadAttr_t ProcessADC_attributes = {
  ...
  .stack_mem = &ADCSignal[0],
  .stack_size = sizeof(ADCSignal),
  .priority = (osPriority_t) osPriorityHigh5,
};
/* Definitions for ADC_request_Period */
...
int main(void)
{
  ...
  /* Create the timer(s) */
  /* creation of ADC_request_Period */
  ADC_request_PeriodHandle = osTimerNew(Callback01, osTimerPeriodic, NULL, &ADC_request_Period_attributes);
  ...
  SchedulerHandle = osThreadNew(StartDefaultTask, NULL, &Scheduler_attributes);

  /* creation of AquireSensorDat */
  AquireSensorDatHandle = osThreadNew(GetAdcVals, NULL, &AquireSensorDat_attributes);

  /* creation of ProcessADC */
  ProcessADCHandle = osThreadNew(GetSignal, NULL, &ProcessADC_attributes);

  /* USER CODE BEGIN RTOS_THREADS */
  /* add threads, ... */
  /* USER CODE END RTOS_THREADS */

  /* creation of SensorZAvailable */
  SensorZAvailableHandle = osEventFlagsNew(&SensorZAvailable_attributes);
...
/**
  * @brief  Function implementing the Scheduler thread.
...
/* USER CODE BEGIN Header_GetAdcVals */
/**
* @brief Function implementing the AquireSensorDat thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_GetAdcVals */
void GetAdcVals(void *argument)
{
  /* USER CODE BEGIN GetAdcVals */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END GetAdcVals */
}

/* USER CODE BEGIN Header_GetSignal */
/**
* @brief Function implementing the ProcessADC thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_GetSignal */
void GetSignal(void *argument)
{
  /* USER CODE BEGIN GetSignal */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END GetSignal */
}
